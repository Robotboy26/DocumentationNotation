; This code may be edited by me, but was not originally made by me.
; =============================================================================
...
; turned off so i can use 25 by 80 text mode
;VBESearch:
;	inc cx
;	cmp cx, 0x5000
;	je halt
...
;	jne VBESearch
;	cmp wod [VBEModeInfoBlock.YResolution], 600 ; Desired YRes here
;	jne VBESearch
;
